...
class TestBuildPortForwardPlan:
    async def test_uses_spec_ports_directly(self):
    ...
    async def test_raises_when_namespace_missing(self):
        ...
        with pytest.raises(MissingNamespaceError):
            await build_port_forward_plan(spec, api)

    async def test_raises_when_service_not_found(self):
    ...
    async def test_resolves_remote_port_from_service(self):
    ...
    async def test_resolves_remote_port_from_pod(self):
    ...
    async def test_pod_spec_port_used_directly(self):
    ...
    async def test_raises_when_pod_not_found(self):
    ...
    async def test_resolves_remote_port_from_deployment(self):
    ...
    async def test_deployment_spec_explicit_port_used_directly(self):
    ...
    async def test_raises_when_deployment_not_found(self):
    ...
    async def test_resolves_remote_port_from_statefulset(self):
    ...
    async def test_statefulset_spec_explicit_port_used_directly(self):
    ...
    async def test_raises_when_statefulset_not_found(self):
    ...
    async def test_resolves_remote_port_from_daemonset(self):
    ...
    async def test_daemonset_spec_explicit_port_used_directly(self):
    ...
    async def test_raises_when_daemonset_not_found(self):
    ...
    async def test_resolves_remote_port_from_replicaset(self):
    ...
    async def test_replicaset_spec_explicit_port_used_directly(self):
    ...
    async def test_raises_when_replicaset_not_found(self):
